...
public void cruce(Cromosoma padre2, Cromosoma hijo1, Cromosoma hijo2,
	...
	//	}
		...
		//System.out.println("Reducido es :" + pila.get(0));
		if (pila.get(0) == "true"){
			return 1;
		}
		else{
	...
	private String reducir(ArrayList<String> reducir) {
		...
		if(reducir.size() == 2){// Es una función NOT
		...
		if(reducir.size() == 3){// Es una función AND o OR
		...
		if(reducir.size() == 4){// Es una función IF
